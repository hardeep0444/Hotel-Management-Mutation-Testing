...
public class Hotel {
    ...
    static void lockRoom(int i,String name,String contact,String gender,String name2,String contact2,String gender2, int rn)
    {
        switch (i) {
            case 1:
...
//
static void CustDetails(int i, int rn, Scanner scanner) {
    System.out.println("in custDetails");
    ...
    System.out.println("Calling lockroom");
    lockRoom(i, name, contact, gender, name2, contact2, gender2, rn);
//    scanner.close();
}
    ...
    public static String features(int i) {
        switch (i) {
            case 1:
...
//                break;
    ...
    static void placeOrder(int rn, int rtype, int i, int q)
    {
        switch (rtype) {
            case 1:
